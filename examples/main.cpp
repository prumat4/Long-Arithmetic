...
int main() {
    ...
    LongNumber ln1 ("104D4A301BD70480050C46201F6AA95018228D200F5CA420252");
    LongNumber ln2 = ln1 + ln1 + ln1 + ln1 + ln1 + ln1 + ln1 + ln1 + ln1;
    LongNumber temp(9);
    LongNumber ln3 = ln1 * temp;
    if(ln3 == ln2)
        std::cout << "SUCCESS" << std::endl;

    std::cout << ln1.toHexString() << std::endl;
    std::cout << ln2.toHexString() << std::endl;
    std::cout << ln3.toHexString() << std::endl;
